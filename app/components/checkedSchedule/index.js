...
export default CheckedSchedule = ({ roomname, checkIn, checker, Time, onClick, fromTime, toTime, teacher, subject,status }) => {
    ...
    return (
        <TouchableOpacity onPress={onClick}>
            ...
            <View style={{ flexDirection: 'row', display: 'flex', alignItems: 'center', }}>
                ...
                <View style={{ backgroundColor: 'orange', justifyContent: 'center', alignItems: 'center', margin: 10, width: 65, height: 30, borderRadius: 5 }}>
